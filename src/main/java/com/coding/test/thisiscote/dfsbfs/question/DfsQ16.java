package com.coding.test.thisiscote.dfsbfs.question;
...
public class DfsQ16 {
    ...
    private List<int[][]> newWallsGraphs;
    private List<Point> point0s;
...
//            }
    ...
    public static void main(String[] args) throws IOException {
        ...
        DfsQ16 sol = ac.getBean(DfsQ16.class);
        ...
        sol.solution(size[0], size[1], graph);
    }
}
